...
GM.RemovePreviousGametype = true --[[ if this is set to true, then the gametype which was played previously will not be present during the vote for the next gametype
